...
const schedule = [
  {
    ...
    events: [
      ...
      { time: "10:00 AM", session: "Praise & Worship" },
      { time: "11:00 AM", session: "Opening Keynote — Pastor Amos Unogwu" },
      { time: "1:00 PM", session: "Lunch Break" },
      { time: "2:30 PM", session: "Leadership Masterclass" },
      { time: "5:00 PM", session: "Evening Impartation Service" },
    ],
  },
  {
    day: "Day 2",
    date: "Saturday, June 6",
    title: "Equipping & Impartation",
    events: [
      { time: "8:00 AM", session: "Morning Prayer & Worship" },
      { time: "9:30 AM", session: "Session 1 — Fresh Oil for Ministry" },
      { time: "11:30 AM", session: "Session 2 — Navigating the New Season" },
      { time: "1:00 PM", session: "Lunch Break" },
      { time: "2:30 PM", session: "Workshops & Breakout Sessions" },
  ...
  },
  {
    ...
    events: [
      ...
      { time: "11:00 AM", session: "Closing Keynote & Prophecy" },
      { time: "12:30 PM", session: "Anointing & Impartation Service" },
      { time: "2:00 PM", session: "Communion & Covenant Meal" },
      { time: "3:30 PM", session: "Closing Remarks & Departure" },
    ],
  },
];
